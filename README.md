...
- **[Deployment Runbook](docs/DEPLOYMENT_RUNBOOK.md)** - Cloud Run deployment procedures and troubleshooting
...
- **Root level**: `README.md` (this file) and `STATE.md`
...
- **`docs/archive/`**: Historical documentation from previous fixes and archived root docs (for reference only)
